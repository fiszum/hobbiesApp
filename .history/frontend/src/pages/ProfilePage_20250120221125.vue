 ...
 * ProfilePage.vue
 * 
 * This component handles the user's profile page, allowing them to view and edit their personal information,
 * manage their hobbies, and change their password. It uses Vue 3's Composition API and Pinia for state management.
 * 
 * State:
 * - user: Holds the current user's data.
 * - newHobby: Input for adding a new hobby.
 * - editMode: Controls the visibility of the edit form for user details.
 * - passwordEditMode: Controls the visibility of the password change form.
 * - isSaving: Indicates whether the profile changes are being saved.
 * - currentPassword, newPassword, confirmNewPassword: Inputs for changing the password.
 * - successMessage, errorMessage: Messages for displaying success or error information.
 * - allHobbies: Stores all hobbies across users.
 * - localFirstName, localLastName, localEmail, localDateOfBirth: Local state for form inputs.
 * 
 * Interfaces:
 * - Friend: Defines the structure of a friend object.
 * - User: Defines the structure of a user object.
 * - Hobby: Defines the structure of a hobby object.
 * 
 * Lifecycle Hooks:
 * - onMounted: Fetches the current user's data, their hobbies, and their friends when the component is mounted.
 * 
 * Methods:
 * - saveChangesToUser: Saves the edited user data to the backend.
 * - addHobbyToUser: Adds a hobby to the user's list of hobbies.
 * - addHobby: Adds a new hobby to the user's list of hobbies.
 * - removeHobby: Removes a hobby from the user's list of hobbies.
 * - updateUserHobby: Syncs the user's hobbies with the backend.
 * - changePassword: Handles the password change process.
 * - fetchUserData: Fetches the current user's data and updates the local state.
 */
